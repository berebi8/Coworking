        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                value={formData.is_incidental ? 'true' : 'false'}
                onChange={(e) => setFormData({
                  ...formData,
                  is_incidental: e.target.value === 'true'
                })}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
              >
                <option value="false">Add-On Service</option>
                <option value="true">Incidental</option>
              </select>
            </div>
              ...
              {!showDeleteConfirm ? (
                ...
                <div className="space-y-3">
                  <p className="text-sm text-text-secondary">
                    To delete this service, type "DELETE" in the field below and click confirm:
                  </p>
                  <input
                    type="text"
