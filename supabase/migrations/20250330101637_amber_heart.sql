/*
  # Update termination notice status enum and add unique constraint

  1. Changes
    - Remove 'completed' from termination_notice_status enum
    - Add unique constraint for active notices per company
    - Add function to check for existing active notices
